...
local arrow
arrow = function(text, color)
  if color == nil then
    color = "blue"
  end
  if ansicolors then
    return "%{" .. tostring(color) .. "}" .. tostring(_arrow(text)) .. "%{reset}"
  else
    return _arrow(text)
  end
end
...
dart = function(text, color)
  ...
  if ansicolors then
    return "%{" .. tostring(color) .. "}" .. tostring(_dart(text)) .. "%{reset}"
  else
    return _dart(text)
  end
end
...
pin = function(text, color)
  ...
  if ansicolors then
    return "%{" .. tostring(color) .. "}" .. tostring(_pin(text)) .. "%{reset}"
  else
    return _pin(text)
  end
end
...
bullet = function(text, color)
  ...
  if ansicolors then
    return "%{" .. tostring(color) .. "}" .. tostring(_bullet(text)) .. "%{reset}"
  else
    return _bullet(text)
  end
end
...
quote = function(text, color)
  ...
  if ansicolors then
    return "%{" .. tostring(color) .. "}" .. tostring(_quote(text)) .. "%{reset}"
  else
    return _quote(text)
  end
end
...
title = function(text, color)
  ...
  if ansicolors then
    return "%{" .. tostring(color) .. "}" .. tostring(_title(text)) .. "%{reset}"
  else
    return _title(text)
  end
end
